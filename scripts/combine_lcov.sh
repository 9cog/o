...
# Unified version for OpenCog (cogutil + atomspace + cogserver)
BASEDIR=.
rm -r ${BASEDIR}/lcov
...
time genhtml -s -o ${BASEDIR}/lcov --demangle-cpp --num-spaces 4 --title "OpenCog Coverage Analysis" ${BASEDIR}/coverage/all.info
